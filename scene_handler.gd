...
var main_menu = preload("res://Scenes/UIScenes/MainMenu.tscn")
var gamemode_select_scene = preload("res://Scenes/UIScenes/GameModeSelect.tscn")
var level_select_scene = preload("res://Scenes/UIScenes/LevelSelect.tscn")
